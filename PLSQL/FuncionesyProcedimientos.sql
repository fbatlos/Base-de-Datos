...
CREATE OR REPLACE PROCEDURE Suma_N (num IN NUMBER,
    num2 In NUMBER) IS
...
crear_depart;				-- 1º No funciona ya que es necesario poner 3 argumentos.
...
CREATE OR REPLACE PROCEDURE Suma_List_N (num IN NUMBER DEFAULT 0,
    num2 In NUMBER DEFAULT 0,num3 In NUMBER DEFAULT 0,num4 In NUMBER DEFAULT 0,num5 In NUMBER DEFAULT 0) IS
