...
C�digo:
	...
	DECLARE
		v_media NUMBER;
	BEGIN
		v_media := fn_CalculaMedia_2(1); -- c�digo del alumno
...
C�digo:
	...
	SELECT *
		...
		---------- -------------------- ---------- -------------------- ---------- ------------
				...
				17 ORDO�EZ BERNALDEZ    JAVIER     c/ Real 3            CASTILLEJA          7,5
		...
		---------- -------------------- ---------- -------------------- ---------- ------------
				...
				17 ORDO�EZ BERNALDEZ    JAVIER     c/ Real 3            CASTILLEJA          
...
C�digo:
	...
	-- Para comprobarlo
		...
		BEGIN
		  ...
		  DBMS_OUTPUT.PUT_LINE('N�mero de alumnos con nota 7: ' || v_num_alumnos);
		  DBMS_OUTPUT.PUT_LINE('N�mero de repetidores con nota 7: ' || v_num_repetidores);
		END;
		/
		
		-- N�mero de alumnos con nota 7: 4
		-- N�mero de repetidores con nota 7: 2
...
C�digo:
	...
	BEGIN
		...
		DBMS_OUTPUT.PUT_LINE('Nombre' || LPAD(' ', 25) || 'Rep' || LPAD(' ', 10) || 'N� Asig Matriculado');
